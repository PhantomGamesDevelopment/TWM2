...
$vehicleReticle[ScoutFlyer, 3, bitmap] = "gui/hud_ret_tankmortar";
$vehicleReticle[ScoutFlyer, 3, frame] = false;

$vehicleReticle[Harrier, 1, bitmap] = "gui/ret_missile";
$vehicleReticle[Harrier, 1, frame] = false;
$vehicleReticle[Harrier, 2, bitmap] = "gui/ret_missile";
$vehicleReticle[Harrier, 2, frame] = false;
$vehicleReticle[Harrier, 3, bitmap] = "gui/hud_ret_tankmortar";
$vehicleReticle[Harrier, 3, frame] = false;

$vehicleReticle[SandstormTank, 1, bitmap] = "gui/ret_missile";
$vehicleReticle[SandstormTank, 1, frame] = true;
