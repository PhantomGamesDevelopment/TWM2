...
* TWM2 Challenge Adjustments
  * Depricated the Blacklist Challenges, It's almost impossible to get any of these.
  * Replaced it with Wargames challenges, which are focused on PvP tasks across all modes.
    * Let's see who can complete some of those "tough" ones :)
  * Finally completed the Zombie Slaying Challenges, allowing players to earn some nice healthy batches of EXP for slaying zombies
